...
export default function RegisterPage(props) {
  ...
  const todayLess16InvertedFormat = moment()
    .subtract(16, "Y")
    .format("DD/MM/YYYY");
          ...
          if (checked) {
            Axios({
              ...
              .catch((error) => {
                ...
                props.setMensaje("Error en la llamada al servidor");
                setTimeout(() => {
                  props.setAlert(false);
                  props.setVariante("");
                }, 3000);
            ...
            <GridItem xs={12} sm={12} md={6}>
              ...
              <Card>
                <form className={classes.form}>
                  ...
                  <p className={classes.divider}>vía mail:</p>
                  {props.alert ? (
                  ...
                  <CardBody>
                    ...
                    <Datetime
                      ...
                      initialViewDate={todayLess16InvertedFormat}
                      timeFormat={false}
